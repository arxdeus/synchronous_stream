...
@internal
final class SynchronousDispatchStreamControllerImpl<T>
    implements SynchronousDispatchStreamController<T> {
  ...
  SynchronousDispatchStreamControllerImpl.broadcast({this.onListen, this.onCancel})
      : isBroadcast = true;
